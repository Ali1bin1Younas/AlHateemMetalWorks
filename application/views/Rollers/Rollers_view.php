...
<link href="<?php echo base_url(); ?>Assets/css/plugins/dataTables/datatables.min.css" rel="stylesheet">
 <!-- Content Wrapper. Contains page content -->
    ...
    <!-- /.content -->
    <input id="callBackLoc" value="<?php echo base_url('Rollers');?>" type="hidden">
  </div>
 <!-- /.content-wrapper -->
...
<script src="<?php echo base_url(); ?>Assets/js/custum/rollers_view.js"></script>
<!-- Page-Level Scripts -->
  <script>
