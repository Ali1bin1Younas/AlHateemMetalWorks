                    ...
                    <div class="col-lg-12 text-right form-group">
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          <li style="padding-left:10px"><b>Cash</b></li>
                          <li><a href="<?php echo base_url(); ?>Moneytransactions/create_cash_spend">Spend Money</a></li>
                          <li><a href="<?php echo base_url(); ?>Moneytransactions/create_cash_receive" class="font-bold">Receive Money</a></li>
                          <li style="padding-left:10px"><b>Bank</b></li>
                          <li><a href="<?php echo base_url(); ?>Moneytransactions/create/3">Spend Money</a></li>
                          <li><a href="<?php echo base_url(); ?>Moneytransactions/create/4">Receive Money</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
...
<script src="<?php echo base_url(); ?>Assets/js/custum/rollers_book_view.js"></script>
<!-- Page-Level Scripts -->
<script>
