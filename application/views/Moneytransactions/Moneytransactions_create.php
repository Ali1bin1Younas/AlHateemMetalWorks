...
<div class="fadeInRight animated">
  <div class="panel panel-default" style="margin-top:10px;" id="createSaleView">
                  ...
                  <div class="col-sm-12">
                            ...
                            <td>
                              <div class="form-group text-left">
                                ...
                                <div class="input-group date">
                                  ...
                                  <input data-bind="textInput: dateReceived" style="width: 100px; margin-bottom: 0px; text-align: center" readonly="readonly" type="text" class="form-control">
                                </div>
                            </td>
                    ...
                    <div class="form-group col-sm-3">
                      <div class="row-fluid pull-left text-left">
                        <label>Persons</label>
                        <div class="controls">
                          <input data-bind="ddlSelect2: person" data-autocomplete="<?php echo base_url(); ?>Moneytransactions/getPersons" data-width="250px"  title="" />
                        </div>
                      </div>
                    </div>
    ...
    <div class="panel-footer" style="padding: 15px 30px">
      ...
      <input id="callBackLoc" value="<?php echo base_url('Moneytransactions');?>" type="hidden">
    </div>
  </div>
</div>
...
<script type="text/javascript">
  ...
  load(bs_url+'Assets/js/plugins/select2/select2.full.min.js').then(bs_url+'Assets/js/custum/moneytransaction_create.js').thenRun(function () {
  ...
  function ReservationsViewModel() {
      ...
      self.createVoucherEnable = ko.computed(function() {
          if(ko.toJSON(self.issueDate) != "" && ko.toJSON(self.person) != undefined && ko.toJSON(self.person) != "null"){return true;}
          else{return false;}
      });
  ...
  $(document).ready(function(){
      ...
      try{
        if($('#txtIsEdit').val() == "1"){
          ...
          $.ajax({
            ...
            success: function(res){
              ...
              viewModel.dateReceived(moment((res_di[1])+'/'+res_di[2]+'/'+res_di[0]).format('DD/MM/YYYY'));
        ...
        viewModel.dateReceived(moment((d.getMonth()+1)+'/'+d.getDate()+'/'+d.getFullYear()).format('DD/MM/YYYY'));
